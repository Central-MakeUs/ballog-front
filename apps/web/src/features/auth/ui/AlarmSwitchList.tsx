...
export const AlarmToggleList = () => {
  const { matchStart, inGame, toggleMatchStart, toggleInGame } =
    useAlarmContext()
  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      <List type="switch" value={matchStart} onToggle={handleToggleMatchStart}>
        경기 시작 알림 받기
      </List>
      <List type="switch" value={inGame} onToggle={handleToggleInGame}>
        경기 중 알림 받기
      </List>
    </div>
  )
