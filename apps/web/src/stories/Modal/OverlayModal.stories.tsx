...
export const HorizontalButtons: Story = {
  render: () => {
    const HorizontalButtonsComponent = () => {
    ...
    return <HorizontalButtonsComponent />
  },
}

export const VerticalButtons: Story = {
  render: () => {
    const VerticalButtonsComponent = () => {
      const [open, setOpen] = useState(true)
    ...
    return <VerticalButtonsComponent />
  },
}

export const WithImage: Story = {
  render: () => {
    const WithImageComponent = () => {
      const [open, setOpen] = useState(true)
