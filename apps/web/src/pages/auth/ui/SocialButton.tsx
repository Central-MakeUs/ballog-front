...
export const KakaoButton = ({ className, ...props }: SocialButtonProps) => {
  ...
  return (
    <Button
      ...
      className={cn(
        'bg-[#FFD337]',
        'justify-between body-sm-medium text-brand-neutral-90',
...
export const AppleButton = ({ className, ...props }: SocialButtonProps) => {
  ...
  return (
    <Button
      ...
      size="lg"
      className={cn(
        'bg-brand-neutral-90 justify-between body-sm-medium text-brand-neutral-white',
        'active:bg-brand-neutral-90/80 py-4',
        className,
      )}
      onClick={() => {
        handleLogin()
